...
public class UserService {
  ...
  public Badge calculateBadge(Integer donorId) {
    long appointmentCount = appointmentRepository.countByDonorId(donorId);
    BadgeType badgeType;
    ...
    String description = "You have " + appointmentCount + " appointments.";
    return new Badge(badgeType, description);
  }
